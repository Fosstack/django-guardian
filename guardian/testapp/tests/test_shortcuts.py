...
class ShortcutsTests(ObjectPermissionTestCase):
    def test_get_perms_for_model(self):
        ...
        self.assertTrue(
            list(get_perms_for_model(self.user)) == list(get_perms_for_model(User))
        )
...
class AssignPermTest(ObjectPermissionTestCase):
    ...
    def test_user_assign_perm_queryset(self):
        ...
        assign_perm(
            self.get_permission("delete_contenttype"), self.user, self.ctype_qset
        )
    ...
    def test_group_assign_perm_queryset(self):
        ...
        assign_perm("change_contenttype", self.group, self.ctype_qset)
        assign_perm(
            self.get_permission("delete_contenttype"), self.group, self.ctype_qset
        )
    ...
    def test_assign_perm_with_dots(self):
        ...
        self.assertTrue(
            self.user.has_perm("contenttypes.contenttype.reorder", self.ctype)
        )
    ...
    def test_user_assign_perm_list(self):
        ...
        assign_perm(
            self.get_permission("delete_contenttype"), self.user, self.ctype_list
        )
    ...
    def test_group_assign_perm_list(self):
        ...
        assign_perm("change_contenttype", self.group, self.ctype_list)
        assign_perm(
            self.get_permission("delete_contenttype"), self.group, self.ctype_list
        )
...
class MultipleIdentitiesOperationsTest(ObjectPermissionTestCase):
    ...
    def test_assign_to_many_users_queryset(self):
        ...
        assign_perm(
            self.get_permission("delete_contenttype"), self.users_qs, self.ctype
        )
    ...
    def test_assign_to_many_users_list(self):
        ...
        assign_perm(
            self.get_permission("delete_contenttype"), self.users_list, self.ctype
        )
        for user in self.users_list:
            self.assertTrue(user.has_perm("add_contenttype", self.ctype))
            self.assertTrue(user.has_perm("delete_contenttype", self.ctype))
    ...
    def test_assign_to_many_groups_queryset(self):
        ...
        assign_perm(
            self.get_permission("delete_contenttype"), self.groups_qs, self.ctype
        )
        for user in self.users_list:
            self.assertTrue(user.has_perm("add_contenttype", self.ctype))
            self.assertTrue(user.has_perm("delete_contenttype", self.ctype))
    ...
    def test_assign_to_many_groups_list(self):
        ...
        assign_perm(
            self.get_permission("delete_contenttype"), self.groups_list, self.ctype
        )
        for user in self.users_list:
            self.assertTrue(user.has_perm("add_contenttype", self.ctype))
            self.assertTrue(user.has_perm("delete_contenttype", self.ctype))
...
class GetPermsTest(ObjectPermissionTestCase):
    ...
    def test_not_model(self):
        self.assertRaises(
            NotUserNorGroup, get_perms, user_or_group=None, obj=self.ctype
        )
...
class GetUsersWithPermsTest(TestCase):
    ...
    def test_only_with_perms_in(self):
        ...
        result = get_users_with_perms(
            self.obj1, only_with_perms_in=("change_contenttype",)
        )
        result_vals = result.values_list("username", flat=True)
    ...
    def test_only_with_perms_in_attached(self):
        ...
        result = get_users_with_perms(
            self.obj1, only_with_perms_in=("delete_contenttype",), attach_perms=True
        )
    ...
    def test_without_group_users_but_perms_attached(self):
        ...
        assign_perm("change_contenttype", self.group2, self.obj1)
        result = get_users_with_perms(
            self.obj1, with_group_users=False, attach_perms=True
        )
    ...
    def test_direct_perms_only(self):
        ...
        result = get_users_with_perms(
            self.obj1, with_superusers=False, with_group_users=True
        )
        self.assertEqual(set(result), expected)
        self.assertEqual(
            set(get_user_perms(self.user1, self.obj1)), {"change_contenttype"}
        )
        ...
        result = get_users_with_perms(
            self.obj1, with_superusers=False, with_group_users=False
        )
    ...
    def test_direct_perms_only_perms_attached(self):
        ...
        result = get_users_with_perms(
            self.obj1, attach_perms=True, with_superusers=False, with_group_users=True
        )
        self.assertEqual(result.keys(), expected.keys())
        for key, perms in result.items():
            self.assertEqual(set(perms), set(expected[key]))
        result = get_users_with_perms(
            self.obj1, attach_perms=True, with_superusers=False, with_group_users=False
        )
    ...
    def test_without_group_users_no_result(self):
        ...
        assign_perm("change_contenttype", self.group1, self.obj1)
        result = get_users_with_perms(
            self.obj1, attach_perms=True, with_group_users=False
        )
        expected = {}
        self.assertEqual(result, expected)
    ...
    def test_without_group_users_no_result_but_with_superusers(self):
        ...
        assign_perm("change_contenttype", self.group1, self.obj1)
        result = get_users_with_perms(
            self.obj1, with_group_users=False, with_superusers=True
        )
        expected = [admin]
...
class GetGroupsWithPerms(TestCase):
    ...
    def test_filter_by_contenttype(self):
        ...
        obj = ContentType.objects.create(
            pk=1042, model="baz", app_label="guardian-tests"
        )
...
class GetObjectsForUser(TestCase):
    ...
    def test_superuser(self):
        ...
        objects = get_objects_for_user(
            self.user, ["contenttypes.change_contenttype"], ctypes
        )
    ...
    def test_with_superuser_true(self):
        ...
        ctypes = ContentType.objects.all()
        objects = get_objects_for_user(
            self.user, ["contenttypes.change_contenttype"], ctypes, with_superuser=True
        )
        self.assertEqual(set(ctypes), set(objects))
    ...
    def test_with_superuser_false(self):
        ...
        objects = get_objects_for_user(
            self.user, ["contenttypes.change_contenttype"], ctypes, with_superuser=False
        )
    ...
    def test_mixed_perms(self):
        ...
        self.assertRaises(
            MixedContentTypeError, get_objects_for_user, self.user, codenames
        )
    ...
    def test_no_app_label_nor_klass(self):
        self.assertRaises(
            WrongAppError, get_objects_for_user, self.user, ["change_group"]
        )
    ...
    def test_klass_as_model(self):
        ...
        objects = get_objects_for_user(
            self.user, ["contenttypes.change_contenttype"], ContentType
        )
    ...
    def test_klass_as_queryset(self):
        assign_perm("auth.change_group", self.user, self.group)
        objects = get_objects_for_user(
            self.user, ["auth.change_group"], Group.objects.all()
        )
        self.assertEqual([obj.name for obj in objects], [self.group.name])
    ...
    def test_multiple_perms_to_check(self):
        ...
        objects = get_objects_for_user(
            self.user, ["auth.change_group", "auth.delete_group"]
        )
    ...
    def test_multiple_perms_to_check_no_groups(self):
        ...
        objects = get_objects_for_user(
            self.user, ["auth.change_group", "auth.delete_group"], use_groups=False
        )
        self.assertEqual(len(objects), 1)
        self.assertTrue(isinstance(objects, QuerySet))
        self.assertEqual(set(objects.values_list("name", flat=True)), {groups[1].name})
    ...
    def test_any_of_multiple_perms_to_check(self):
        ...
        objects = get_objects_for_user(
            self.user, ["auth.change_group", "auth.delete_group"], any_perm=True
        )
    ...
    def test_groups_perms(self):
        ...
        self.assertEqual(
            set(objects.values_list("id", flat=True)), {ctypes[i].id for i in [0, 1]}
        )
    ...
    def test_object_based_permission_with_groups_3perms(self):
        ...
        self.assertEqual(
            set(objects.values_list("id", flat=True)), {ctypes[0].id, ctypes[1].id}
        )
    ...
    def test_varchar_primary_key(self):
        ...
        self.assertTrue(isinstance(objects, QuerySet))
        self.assertEqual(
            set(objects.values_list("pk", flat=True)), {obj_with_char_pk.pk}
        )
    ...
    def test_uuid_primary_key(self):
        ...
        self.assertTrue(isinstance(objects, QuerySet))
        self.assertEqual(
            set(objects.values_list("pk", flat=True)), {obj_with_uuid_pk.pk}
        )
    ...
    def test_model_inheritance(self):
        ...
        children = get_objects_for_user(
            self.user, "testapp.change_childtestmodel", ChildTestModel
        )
...
class GetObjectsForGroup(TestCase):
    ...
    def test_mixed_perms(self):
        ...
        self.assertRaises(
            MixedContentTypeError, get_objects_for_group, self.group1, codenames
        )
    ...
    def test_no_app_label_nor_klass(self):
        self.assertRaises(
            WrongAppError, get_objects_for_group, self.group1, ["change_contenttype"]
        )
    ...
    def test_klass_as_model(self):
        ...
        objects = get_objects_for_group(
            self.group1, ["contenttypes.change_contenttype"], ContentType
        )
    ...
    def test_klass_as_manager(self):
        assign_perm("contenttypes.change_contenttype", self.group1, self.obj1)
        objects = get_objects_for_group(
            self.group1, ["change_contenttype"], ContentType.objects
        )
    ...
    def test_klass_as_queryset(self):
        assign_perm("contenttypes.change_contenttype", self.group1, self.obj1)
        objects = get_objects_for_group(
            self.group1, ["change_contenttype"], ContentType.objects.all()
        )
        self.assertEqual(list(objects), [self.obj1])
