...
class UserPermissionTests(TestDataMixin, TestCase):
    ...
    def test_assignement(self):
        ...
        UserObjectPermission.objects.assign_perm(
            "change_contenttype", self.user, self.ctype
        )
    ...
    def test_assign_perm_validation(self):
        ...
        create_info = dict(
            permission=perm, user=self.user, content_type=ctype, object_pk=group.pk
        )
        self.assertRaises(
            ValidationError, UserObjectPermission.objects.create, **create_info
        )
...
class GroupPermissionTests(TestDataMixin, TestCase):
    ...
    def test_assignement(self):
        ...
        GroupObjectPermission.objects.assign_perm(
            "change_contenttype", self.group, self.ctype
        )
        self.assertTrue(self.user.has_perm("change_contenttype", self.ctype))
        self.assertTrue(
            self.user.has_perm("contenttypes.change_contenttype", self.ctype)
    ...
    def test_ctypes(self):
        GroupObjectPermission.objects.assign_perm(
            "change_contenttype", self.group, self.obj1
        )
        self.assertTrue(self.user.has_perm("change_contenttype", self.obj1))
        self.assertFalse(self.user.has_perm("change_contenttype", self.obj2))
        ...
        GroupObjectPermission.objects.assign_perm(
            "change_contenttype", self.group, self.obj2
        )
        self.assertTrue(self.user.has_perm("change_contenttype", self.obj2))
        self.assertFalse(self.user.has_perm("change_contenttype", self.obj1))
    ...
    def test_assign_perm_validation(self):
        ...
        create_info = dict(
            permission=perm, group=self.group, content_type=ctype, object_pk=user.pk
        )
        self.assertRaises(
            ValidationError, GroupObjectPermission.objects.create, **create_info
        )
