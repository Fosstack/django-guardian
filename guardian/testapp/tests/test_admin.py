...
class AdminTests(TestCase):
    ...
    def test_view_manage_group_form(self):
        ...
        self.assertEqual(response.redirect_chain[0][1], 302)
        redirect_url = reverse(
            "admin:%s_%s_permissions_manage_group" % self.obj_info,
...
class GuardedModelAdminTests(TestCase):
    ...
    def test_obj_perms_manage_user_form_attr(self):
        ...
        gma = self._get_gma(attrs=attrs)
        self.assertTrue(
            issubclass(gma.get_obj_perms_manage_user_form(None), forms.Form)
        )
    ...
    def test_obj_perms_user_select_form_attr(self):
        ...
        gma = self._get_gma(attrs=attrs)
        self.assertTrue(
            issubclass(gma.get_obj_perms_user_select_form(None), forms.Form)
        )
    ...
    def test_obj_perms_manage_group_form_attr(self):
        ...
        gma = self._get_gma(attrs=attrs)
        self.assertTrue(
            issubclass(gma.get_obj_perms_manage_group_form(None), forms.Form)
        )
    ...
    def test_obj_perms_group_select_form_attr(self):
        ...
        gma = self._get_gma(attrs=attrs)
        self.assertTrue(
            issubclass(gma.get_obj_perms_group_select_form(None), forms.Form)
        )
    ...
    def test_user_can_acces_owned_objects_only_unless_superuser(self):
        ...
        qs = gma.get_queryset(request)
        self.assertEqual(
            sorted([e.pk for e in qs]), sorted([joe_entry.pk, jane_entry.pk])
        )
...
class GrappelliGuardedModelAdminTests(TestCase):
    ...
    def test_get_obj_perms_manage_template(self):
        gma = self._get_gma()
        self.assertEqual(
            gma.get_obj_perms_manage_template(),
    ...
    def test_get_obj_perms_manage_group_template(self):
        gma = self._get_gma()
        self.assertEqual(
            gma.get_obj_perms_manage_group_template(),
