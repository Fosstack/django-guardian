...
class TestMixedDirectAndGenericObjectPermission(TestCase):
    ...
    def test_get_users_with_perms_plus_groups(self):
        ...
        self.assertEqual(
            get_users_with_perms(self.mixed, attach_perms=True),
            {
    ...
    def test_get_users_with_perms_plus_groups_reverse_mixed(self):
        ...
        self.assertEqual(
            get_users_with_perms(self.reverse_mixed, attach_perms=True),
            {
        ...
        self.assertEqual(sorted(p.pk for p in result), sorted([self.reverse_mixed.pk]))
