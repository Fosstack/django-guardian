...
def monkey_patch_user():
    ...
    setattr(
        User,
        "add_obj_perm",
        lambda self, perm, obj: UserObjectPermission.objects.assign_perm(
            perm, self, obj
        ),
    )
    setattr(
        User,
        "del_obj_perm",
        lambda self, perm, obj: UserObjectPermission.objects.remove_perm(
            perm, self, obj
        ),
    )
...
def monkey_patch_group():
    ...
    setattr(
        Group,
        "add_obj_perm",
        lambda self, perm, obj: GroupObjectPermission.objects.assign_perm(
            perm, self, obj
        ),
    )
    setattr(
        Group,
        "del_obj_perm",
        lambda self, perm, obj: GroupObjectPermission.objects.remove_perm(
            perm, self, obj
        ),
    )
